function [errors,jacobi] = getErrorAndJac_2D(q1,q2,gyr1,gyr2,j1,j2,delta,constraint)

switch constraint
    case 'euler'
        [errors,jacobi] = getJac_euler_cons(delta,q1,q2,j1,j2);
    case 'gyro'
        [errors,jacobi] = getJac_gyro_cons(j1,j2,q1,q2,gyr1,gyr2,delta);
    case 'combined'
        [errors,jacobi] = getJac_comb_cons(j1,j2,q1,q2,gyr1,gyr2,delta);
    otherwise
...
error = getConstraintWeight('2D_static',{j1,j2},q1,q2).*(second_angle); 
...
errors_euler = getConstraintWeight('2D_static',{j1,j2},q1,q2).*(second_angle); 
