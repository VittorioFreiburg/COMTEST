function [SponSwayMinusStim]=SpSw_Minus_Stimulus(stim,resp1,ampRot,ampTrans) 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% entspricht PRTS2012 vom 9.Juli 2012 mit dem Unterschied des Outputs
% sollte evtl. als PRTS2012 mit 2 Outputs 
% und nur für die Reize 2,3,4,7 
% in das reguläre Skript SwayRun eingefügt werden
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% SponSwayMinusStim Output
if ampRot > 0.1
    SponSwayMinusStim.f = fs12;
    SponSwayMinusStim.yo = yosd12;
    SponSwayMinusStim.ps = conj(yosd12).* yosd12;
end
...
%% SponSwayMinusStim Output
if ampTrans > 0.1
    SponSwayMinusStim.f = fs32;
    SponSwayMinusStim.yo = yosd32;
    SponSwayMinusStim.ps = conj(yosd32).* yosd32;
end
