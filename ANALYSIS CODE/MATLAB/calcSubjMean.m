function [subject]=calcSubjMean(subject)
                ...
                for fn3z = 1:lfn3(1);
                    ...
                    sammel = [];
                     for wdh = 1:2
                        ...
                        if wdh==2
                            eval(['subject.eyes{eye}.subjMean.sponSway.',fn1Text,'.',fn2Text,'.',fn3Text,'= nanmean(sammel,3);']);
                            ...
                            if strcmp(fn2Text,'paras')&& strcmp(fn3Text,'freq')
                                ...
                                eval(['subject.eyes{eye}.subjMean.sponSway.',fn1Text,'.',fn2Text,'.rowLabels = paraRowLabels;'])
                            end
                        end
                     end%wdh 1:2
                end % fn3
    ...
    for fn1z = 1:lfn1(1);
        ...
        for rm = 1:4 % zeile Reizmatrix;
            ...
            for fn3z = 1:lfn3
                ...
                eval(['subject.eyes{eye}.subjMean.prts.',fn1Text,'.',fn2TextNew,'.',fn3Text,'= nanmean(sammel,3);']);
                eval(['subject.eyes{eye}.subjSD.prts.',fn1Text,'.',fn2TextNew,'.',fn3Text,'= nanstd(sammel,0,3);']);
            end % fn3
            eval(['tf =subject.eyes{eye}.subjMean.prts.',fn1Text,'.',fn2TextNew,'.tf;']);
            eval(['subject.eyes{eye}.subjMean.prts.',fn1Text,'.',fn2TextNew,'.mag = abs(tf);']); %Gain
            ...
            eval(['subject.eyes{eye}.subjMean.prts.',fn1Text,'.',fn2TextNew,'.pha = pha;']);            
